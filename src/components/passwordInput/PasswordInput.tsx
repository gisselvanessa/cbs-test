...
// const PasswordInput = (field: FieldInputProps<string>, props: PasswordInputProps, color:PasswordInputProps2 ) => {
// const PasswordInput = ({ field, color, ...props }: PasswordInputProps & FieldInputProps<string>) => {
const PasswordInput = ({ ...props }: PasswordInputProps) => {
  const field = props as FieldInputProps<string>;
